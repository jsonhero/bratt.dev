const tokens = {
  ...
  "colors.text.paragraph": {
    "value": "var(--colors-text-paragraph)",
    "variable": "var(--colors-text-paragraph)"
  },
  "colors.background": {
  ...
  "colors.colorPalette.paragraph": {
    "value": "var(--colors-color-palette-paragraph)",
    "variable": "var(--colors-color-palette-paragraph)"
  }
}
